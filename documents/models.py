...
class Document(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.document_number is None:
            ...
            self.document_number = (
                1
                if not last_doc
                else last_doc.document_number + 1
            )
    ...
    def delete(self, *args, **kwargs):
        ...
        # -----------------------------------------
        # Delete uploaded scanned PDF
        # -----------------------------------------

        if self.scanned_copy:

            try:
                self.scanned_copy.delete(
                    save=False
                )
            except Exception:
                pass
